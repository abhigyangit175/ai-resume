  ...
  return (
    <div className="hover:scale-105 transition-all hover:shadow-md shadow-primary">
      <Link to={"/dashboard/resume/" + resume.documentId + "/edit"}>
        <div className="p-14 bg-gradient-to-b from-pink-100 via-pink-200 to-blue-200 flex items-center justify-center h-[280px] rounded-t-lg border-t-4 ">
          {/* <Notebook /> */}
          <img src="/cv.png" alt="resume" height={80} width={80} />
        </div>
      </Link>
      <div
        className="border p-3 flex justify-between text-white items-end rounded-b-lg bg-primary"
